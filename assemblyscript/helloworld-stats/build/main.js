...
/* harmony import */ var lowdb__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lowdb */ "lowdb");
...
const db = lowdb__WEBPACK_IMPORTED_MODULE_1___default()(adapter);
...
app.post('/record-stat', (req, res) => {
  db.get('stats').push(_objectSpread({}, req.body)).write();
  res.status(200).send();
});
...
module.exports = __webpack_require__(/*! /home/thomas/gitrepos/wasm-lower-level/assemblyscript/helloworld-stats/src/index.js */"./src/index.js");
